...
// Block server startup until intent detection is initialized
(async () => {
  try {
    ...
    app.post("/api/chat", async (req: any, res: any) => {
      ...
      if (
        ...
        return res
          .status(400)
          .json({ reply: "Please provide a valid username." });
      }
      ...
      try {
        ...
        console.log(
          `Supabase history for ${userId}:${sessionId}:`,
          parsedHistory
        );
